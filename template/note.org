...
*** 最短路
**** Dijkstra
形似贪心的算法，每次选取权值最小的节点，当边指向的节点的权值比节点储存的节点小时更新节点
*** 环
**** 并查集
...
**** zwk 线段树
 [[https://zhuanlan.zhihu.com/p/29876526][Mike He 的讲解]] ，[[https://www.luogu.com.cn/blog/pks-LOVING/senior-data-structure-qian-tan-xian-duan-shu-segment-tree][洛谷日报]],[[http://codeforces.com/blog/entry/18051][ Efficient and easy segment trees]]

 [[./figure/zkw.png]]
 #+INCLUDE: ./04_zkw_segment_tree.cpp src cpp
