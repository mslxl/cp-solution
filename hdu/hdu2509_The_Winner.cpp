// Problem: Be the Winner
// Contest: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/34655/F
...
void solve(const std::size_t testcase) {
  ...
  debug(sg_sum, cnt_sg_le1, n);
  if((sg_sum != 0 && cnt_sg_le1 < n) || (sg_sum == 0 && cnt_sg_le1 == n)){
    std::cout << "Yes";
  }else{
    std::cout << "No";
  }
