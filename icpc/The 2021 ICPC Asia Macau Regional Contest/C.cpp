...
// Contest: Codeforces - 2023 SDCPC Training Team - SDUFE
// URL: https://codeforces.com/group/DERTxRJh4A/contest/104373/problem/C
// Memory Limit: 256 MB
// Time Limit: 2000 ms
//
...
bool up(Point a) { return a.y > 0 || (a.y == 0 && a.x >= 0); }
...
void solve(std::size_t testcase) {
  ...
  for (int i = 1, j = 1; i <= n; i++) {
    ...
    res = std::min(res, std::min(j - i + 1, n - j + i - 1));
  }
  std::cout << res << "\n";
}