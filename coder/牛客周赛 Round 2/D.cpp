// Problem: 小红打怪
// Contest: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/60456/D
...
void solve(const std::size_t testcase) {
  ...
  rep1(i, q){
    ...
    x = h + x * k;
    debug(x);
    auto iter = std::lower_bound(php, php+1+n, x-1, [](const int &l, const int &r){
      return l <= r;
    });
    int ans = iter - php - 1;
