...
class HelloWorld(Scene):
    def construct(self):
        ...
        tex_text = Tex(r'$\int^{Life}_{Death} Roll = Life$')
        self.add(tex_text)
        self.play(Create(tex_text))
        ...
        self.play(tex_text.move_to, DOWN, {
            'aligned_edge': DOWN
        })
        ...
        self.play(text.next_to, tex_text, LEFT, {'aligned_edge': DOWN})
